...
public class BinaryExample {
    public static void main(String[] args) {
        ...
        // Criando um BinaryOperator para somar dois números (usando referência de
        // método)
        BinaryOperator<Integer> somar2 = Integer::sum;

        // Usando a Stream API para reduzir (ou acumular) os números através da soma
        // O valor inicial para acumulação é 0
        int novoResultado = numeros.stream().reduce(0, somar2); // Erro aqui!

        // Usando o método sum da classe Integer para realizar a soma
        // int novoResultado = numeros.stream().reduce(0, Integer::sum); // Erro de duplicação de variável
